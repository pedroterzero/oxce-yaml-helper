...
export const typeLinks: TypeLinks = {
    ...
    // 2024-02-06 seems gone
    // 'alienRaces.retaliationMission': ['alienMissions'],
    '/^alienRaces\\.retaliationMissionWeights\\.\\d+$/': ['alienMissions'],
    ...
    'enviroEffects.paletteTransformations.key': ['builtinsOnly'], // should only match builtins (so link to non existing type)
    ...
    // also update in builtinTypes.ts
    '/^startingBase(Beginner|Experienced|Veteran|Genius|Superhuman)?\\.crafts\\[\\]\\.type$/': ['crafts'],
    '/^startingBase(Beginner|Experienced|Veteran|Genius|Superhuman)?\\.crafts\\[\\]\\.weapons\\[\\].type$/': [
        'craftWeapons',
    ],
    '/^startingBase(Beginner|Experienced|Veteran|Genius|Superhuman)?\\.crafts\\[\\]\\.status$/': ['builtinsOnly'],
    '/^startingBase(Beginner|Experienced|Veteran|Genius|Superhuman)?\\.facilities\\[\\]\\.type$/': ['facilities'],
    '/^startingBase(Beginner|Experienced|Veteran|Genius|Superhuman)?\\.items\\[\\]\\.type$/': ['items'],
    '/^startingBase(Beginner|Experienced|Veteran|Genius|Superhuman)?\\.randomSoldiers$/': ['soldiers'],
    // startingBase.items[].type
    ...
    '/^ufos\\.raceBonus\\.[a-zA-Z0-9_]+.(craftCustomDeploy|missionCustomDeploy)$/': ['alienDeployments'],
    'units.armor': ['armors'],
