...
export class RulesetCompletionProvider implements CompletionItemProvider {
    public provideCompletionItems(document: TextDocument, position: Position, _token: CancellationToken, _context: CompletionContext): ProviderResult<CompletionItem[] | CompletionList> {
        ...
        return this.buildCompletionItemList(target, key?.key, folder);
    ...
    private transformFilterResultIntoCompletionItemList(filteredKeys: DefinitionCompletions/*, prefixToRemove: string, i18nKeyToComplete: string, workspaceFolder: WorkspaceFolder*/): CompletionItem[] {
        const ret = [];
    ...
    private buildCompletionItem(filteredKey: string, data: DefinitionCompletion/*, prefixToRemove: string, i18nKeyToComplete: string, workspaceFolder: WorkspaceFolder*/): CompletionItem {
